                        ...
                        <Row className="vertical-content justify-content-center">
                            <Col lg={6}>
                                <div className="hero-wrapper mb-4">
                                    ...
                                    <div className="mt-4">
                                        <Link to="#" className="btn btn-primary mt-2 me-2">Get Started</Link>
                                        <Link to="#" className="btn btn-success mt-2 me-2 ms-1">Learn more</Link>
                                    </div>
                                </div>
                                ...
                                <Card className="mx-auto p-4 rounded mt-5 mt-lg-0">
                                    ...
                                    <Form className="registration-form">
                                        <FormGroup className="mb-3">
                                            <Label className="font-15 text-muted">Your Name*</Label>
                                            <Input type="text" className="form-control" id="name" placeholder="" required />
                                        </FormGroup>
                                        <FormGroup className="mb-3">
                                            <Label className="font-15 text-muted">Your Email*</Label>
                                            <Input type="email" className="form-control" id="email" placeholder="" required />
                                        </FormGroup>
                                        <FormGroup className="mb-3">
                                            <Label className="font-15 text-muted">Password*</Label>
                                            <Input type="password" className="form-control" id="password" placeholder="" required />
                                        </FormGroup>
                                        <Button type="submit" color="primary" size="sm" block>Get Started <i className="mdi mdi-telegram ms-2"></i></Button>
                                    </Form>
                                </Card>
                            </Col>
                        </Row>
